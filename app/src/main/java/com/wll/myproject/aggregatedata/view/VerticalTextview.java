...
//                    t.setTextColor(getResources().getColor(R.color.tx_66));
//                    t.setTextSize(13);
//                    t.setClickable(true);
...
//        }
    ...
    public void startAutoScroll() {
        if (textList.size() > 0) {
        setText( Html.fromHtml(textList.get(textList.size()-1)));}
            ...
            public void onClick(View v) {
                try {
                    if (itemClickListener != null && textList.size() > 0 && currentId != -1) {
                        ...
                        itemClickListener.onItemClick(textList.size()-1);
                    }else if(textList.size()==0){
                        return;
                    }
                } catch (Exception e) {
